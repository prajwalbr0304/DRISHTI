...
_SPECS: tuple[RefSpec, ...] = (
    ...
    RefSpec("CasePartyRole", "CasePartyRole", "CasePartyRoleID", "accused",
            label_cols=("DisplayName", "RoleType"),
            summary_cols=("RoleType", "PartyNature", "CaseMasterID", "CanonicalPersonID",
                          "CanonicalOrganisationID", "IsUnknownParty"),
    ...
    RefSpec("EvidenceItem", "EvidenceItem", "EvidenceItemID", "document",
            ...
            summary_cols=("EvidenceType", "MimeType", "ByteSize", "Sha256", "Status",
                          "CaseMasterID"),
...
def hydrate(ref_table: Optional[str], ref_id: Optional[str], *,
    ...
    """
    # Self-snapshot / content kinds: no DB ref (client carries a bounded snapshot).
    if not ref_table or (requested_kind in _SELF_SNAPSHOT_KINDS):
