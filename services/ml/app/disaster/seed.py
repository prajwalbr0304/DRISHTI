...
# seed.py lives at DRISHTI/services/ml/app/disaster/seed.py -> repo root is parents[4].
_REPO_ROOT = Path(__file__).resolve().parents[4]
_FIXTURE = _REPO_ROOT / "datagen" / "fixtures" / "golden-001" / "disaster_response.json"
_DATAGEN = _REPO_ROOT / "datagen" / "disaster.py"
